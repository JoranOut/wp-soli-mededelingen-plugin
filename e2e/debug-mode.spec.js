 ...
 * display_errors untouched when WP_DEBUG is false, and then no PHP diagnostic of
 ...
 * WP_DEBUG: true does not reach the environment Playwright runs against. This
...
/**
 * Read a constant's reported state from the Site Health "Info" tab.
 *
 * The constants sit in a collapsed accordion panel, so the value is read via
 * toHaveText (which uses textContent) rather than innerText, which is empty for
 * hidden elements.
 *
